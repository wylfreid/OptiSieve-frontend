import {
  ...
  import Frame3 from "../../../assets/images/shapes/Frame3";
  
  
  
  export default function OnboardingScreen_3(props) {
    ...
    return (
      ...
      >
        ...
        <View style={styles.topContainer}>
          <Frame3 style={styles.frame} />
  
        </View>
  
        <View style={styles.bottomContainer}>
          <Text style={styles.title} >Puissant</Text>
